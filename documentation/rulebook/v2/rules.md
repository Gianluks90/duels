...
**2.5 - Residuo Arcano**
Ogni Residuo Arcano non vale alcun mana e appartiene a un mazzo speciale composto da 8 copie di questa carta. Per ottenere un residuo basta combinare due elementi base opposti durante la fase Azione (Fuoco + Acqua, oppure Aria + Terra). Quando un residuo viene pescato, il giocatore ha un turno per utilizzarlo, dopodiché si consuma. Il residuo vale come un qualsiasi elemento base ai fini di qualsiasi combinazione; tuttavia non è un elemento, quindi non è soggetto a nessun effetto o regola che faccia riferimento agli elementi.
